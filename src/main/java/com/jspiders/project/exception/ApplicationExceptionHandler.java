...
public class ApplicationExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<ErrorStructure> userEmailAlreadyFound(EmailAlreadyExistsException exc){
		ErrorStructure structure = new ErrorStructure();
		structure.setStatusCode(HttpStatus.FOUND.value());
		structure.setMessage(exc.getMessage());
		structure.setRootCause("Account with this email is already there!!!");
